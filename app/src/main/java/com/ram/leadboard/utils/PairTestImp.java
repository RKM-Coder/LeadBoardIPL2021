...
public class PairTestImp {
	...
	public static void main(String[] args) {
		...
		if (myList.size() == 2) {
			...
			ArrayList<PairData<String, String>> result = getPairData(myList);
			System.out.println("" + result);
			ArrayList<String> tempResult = getResultBySimulate(result);
			System.out.println("" + tempResult);
			if (isListEven(tempResult)) {
				ArrayList<PairData<String, String>> result2 = getPairData(tempResult);
	...
	private static ArrayList<String> getResultBySimulate(ArrayList<PairData<String, String>> result) {
	...
	private static boolean isListEven(List<String> myList) {
	...
	private static ArrayList<PairData<String, String>> getPairData(List<String> array) {
